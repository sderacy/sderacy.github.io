...
const about = {
  ...
  resume: 'https://drive.google.com/file/d/124lCd2tE3rQUqiRCVDokSTkg_B3EBiYB/view?usp=sharing',
  social: {
...
const projects = [
  ...
  // if there are no projects, Projects section won't show up
  {
    ...
    stack: ['HTML', 'CSS', 'JavaScript', 'NodeJS', 'ExpressJS', 'Bootstrap', 'SQLite', 'Google Charts API', 'Web Speech API', 'Git', 'Github'],
  ...
  },
  {
    ...
    stack: ['HTML', 'CSS', 'JavaScript', 'Bootstrap', 'Django', 'Git', 'Github'],
